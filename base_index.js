...
const KOMARI_KEY = process.env.KOMARI_TOKEN || 'hoster24.adg007.kdns.fr';              // komari 自动发现密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiM2ZmYjdmOWMtYzA3NC00OTM5LWEwOTktNzA0MWRhYjUxNmQ3IiwicyI6Ik5HVXpNR1V6WTJRdE9ETTFZaTAwT0RFMExXSXhNVEF0WXpZek56Tm1ZakUxWXpNMCJ9';          // 固定隧道域名,留空即启用临时隧道
